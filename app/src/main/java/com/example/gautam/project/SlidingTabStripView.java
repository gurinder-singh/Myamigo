...
public class SlidingTabStripView extends HorizontalScrollView {
    ...
    public SlidingTabStripView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabStripView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new SlidingTabLayout(context);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link SlidingTabStripView} you are
